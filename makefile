...
SOURCES0=main.cpp log.cpp common.cpp lib/fec.cpp lib/rs.cpp crc32/Crc32.cpp packet.cpp delay_manager.cpp immediate_send_batch.cpp receive_batch.cpp fd_manager.cpp connection.cpp fec_manager.cpp adaptive_fec.cpp misc.cpp tunnel_client.cpp tunnel_server.cpp
